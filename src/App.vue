    ...
    <div class="bg-gray-100 mx-auto py-8">
      ...
      <div class=" flex flex-wrap justify-center gap-2">
        <button
          ...
          :key="trophy"
          class=" bg-green-700 py-2 px-4 text-sm sm:text-md md:text-lg text-gray-100 shadow-md focus:outline-none hover:bg-green-600 active:bg-green-700 rounded-md"
